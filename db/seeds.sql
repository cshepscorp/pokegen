...
INSERT INTO pokemon (name, type, type2, ability1, ability2, ability3, user_id)
VALUES
("Pikachu", "Electric", null, "Static", null,  "Lightningrod", 1),
("Squirtle", "Water", null, "Torrent", null,  "Rain Dish", 1),
("Robin Hood", "Fighting", "Dark", "Tactical Mind", "Attack Master",  "Emboldened Spirit", 2);
