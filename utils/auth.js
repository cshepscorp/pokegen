...
checking for the existence of a session property and using res.redirect() if it's not there.
If res.session.user_id does exist, it will call next(),
which could potentially be another middleware function or the final function that will render the template.
*/
